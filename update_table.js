const fs = require('fs');
let text = fs.readFileSync('src/app/admin/live-data/ProjectByStatusModal.tsx', 'utf8');

// 1. Container overflow & maxHeight
text = text.replace(
...
fs.writeFileSync('src/app/admin/live-data/ProjectByStatusModal.tsx', text);
console.log("Updated!");
