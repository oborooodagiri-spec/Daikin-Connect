...
// We need to inject the TAMBAH and SELESAI handlers.
// I'll do this by overwriting the entire file since it's getting complex.
const fullCode = `import { NextRequest, NextResponse } from 'next/server';
...
`;
fs.writeFileSync('src/app/api/v1/webhook/whatsapp/route.ts', fullCode, 'utf8');
