const fs = require('fs');
let text = fs.readFileSync('src/app/admin/live-data/StatusPipelineModal.tsx', 'utf8');
...
fs.writeFileSync('src/app/admin/live-data/StatusPipelineModal.tsx', text);
console.log("Updated StatusPipelineModal");
