...
const startIdx = lines.findIndex(l => l.includes("export const exportSectorMatrix"));
const endIdx = lines.findIndex(l => l.includes("export const exportHierarchyTree"));

const newFunc = `export const exportSectorMatrix = async (deals: any[], fy: number, sectorName: string, filename: string) => {
