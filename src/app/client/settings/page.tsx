    ...
    <div className="max-w-4xl mx-auto space-y-10 pb-20">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div className="space-y-2">
           {[
             { label: "Preferences", icon: Settings, active: true },
             ...
             <button 
               ...
               className={`w-full flex items-center gap-3 px-6 py-4 rounded-2xl text-xs font-black uppercase tracking-widest transition-all ${
                 item.active ? "bg-[#003366] text-white shadow-xl shadow-blue-900/10" : "bg-white text-slate-400 hover:bg-slate-50 border border-slate-100"
               }`}
             >
               <item.icon size={16} />
               {item.label}
        ...
        <div className="md:col-span-2 space-y-6">
           ...
           <div className="bg-white border border-slate-200 rounded-[2.5rem] shadow-sm p-8 sm:p-10 opacity-40 grayscale pointer-events-none">
              <h3 className="text-lg font-black text-[#003366] tracking-tight mb-6">Theme Customization</h3>
              <div className="grid grid-cols-2 gap-4">
                 <div className="h-24 bg-slate-50 rounded-2xl border-2 border-slate-200 border-dashed" />
                 <div className="h-24 bg-slate-50 rounded-2xl border-2 border-slate-200 border-dashed" />
              </div>
           </div>
        </div>
