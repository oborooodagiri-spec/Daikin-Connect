...
export default function AttendanceRecordsPage() {
  ...
  const handleExport = () => {
    ...
    const csv = records.map(r => {
      ...
      const checkOutStr = r.check_out_photo && r.check_out_photo !== "" ? new Date(r.check_out_time).toLocaleString() : "";
                      ...
                      <td className="px-10 py-7">
                        <div className="space-y-2">
                           <div className="flex items-center gap-2 text-[13px] font-black text-slate-700">
                              ...
                              <span className={r.check_out_photo && r.check_out_photo !== "" ? "text-rose-500" : "text-amber-500 animate-pulse"}>
                                 {r.check_out_photo && r.check_out_photo !== "" ? formatDate(r.check_out_time) : "ON SITE"}
                              </span>
                           </div>
