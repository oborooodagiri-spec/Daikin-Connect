          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
            <div className="space-y-4">
              ...
              <div>
                  <h1 className="text-4xl font-black text-[#003366] tracking-tight">
                    Login <span className="text-[#00a1e4]">History</span>
                  </h1>
              </div>
            </div>
            ...
            <div className="flex bg-slate-100 p-1.5 rounded-2xl border border-slate-200">
              <button 
                ...
                className="px-6 py-2.5 rounded-xl text-[10px] font-black uppercase tracking-widest transition-all bg-white text-[#00a1e4] shadow-sm"
              >
                Log Tracker
              </button>
            </div>
            ...
            <div className="bg-white rounded-[2.5rem] border border-slate-200 shadow-xl shadow-slate-200/50 overflow-hidden sticky top-24">
                ...
                <div className="px-8 pb-10">
                  <div className="relative -mt-12 mb-8">
                      <div className="w-24 h-24 rounded-[2rem] bg-white border-4 border-white shadow-2xl flex items-center justify-center text-[#003366] overflow-hidden">
                        {profile?.avatarUrl ? (
                           ...
                           <div className="w-full h-full bg-gradient-to-br from-[#003366] to-[#00a1e4] flex items-center justify-center text-white text-3xl font-black">
                             {profile?.name ? profile.name.split(" ").map((w: string) => w[0]).join("").slice(0, 2).toUpperCase() : <User size={48} />}
                           </div>
                        )}
                      </div>
                  </div>
                  ...
                  <div className="space-y-6">
                      <div>
                        <h3 className="text-xl font-black text-slate-800 tracking-tight text-center">{profile?.name}</h3>
                      </div>
                  </div>
                </div>
            </div>
