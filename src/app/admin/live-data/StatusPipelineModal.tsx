...
interface StatusPipelineModalProps {
  isOpen: boolean;
  onClose: () => void;
  deals: Deal[];
  initialFY?: number;
...
export default function StatusPipelineModal({ 
  isOpen, 
  onClose, 
  deals, 
  initialFY = 26, 
      ...
      <div style={{ position: "fixed", inset: 0, zIndex: 9999, display: "flex", alignItems: "center", justifyContent: "center" }}>
        ...
        >
          ...
          <div style={{ flex: 1, overflow: "auto", display: "flex", flexDirection: "column", padding: "0 32px 0 32px", gap: 32, background: "#ffffff" }}>
            ...
            {/* Pivot Table */}
            <div style={{ flex: 1, minWidth: "max-content", minHeight: 400, display: "flex", flexDirection: "column", background: "white", borderRadius: 20, border: "1px solid #e2e8f0", overflow: "visible", marginBottom: 32, boxShadow: "0 4px 6px -1px rgba(0,0,0,0.05)" }}>
              <div style={{ flex: 1 }}>
