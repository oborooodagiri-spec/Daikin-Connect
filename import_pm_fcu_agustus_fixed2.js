      ...
      if (existingActivity) {
        ...
        await prisma.service_activities.update({
          ...
          data: {
            ...
            amp_r: ampAfterR ? parseFloat(ampAfterR) : existingActivity.amp_r,
            room_db: tempRoomAfter ? parseFloat(tempRoomAfter) : existingActivity.room_db
          }
        });
      } else {
        await prisma.service_activities.create({
          data: {
            ...
            amp_r: ampAfterR ? parseFloat(ampAfterR) : null,
            room_db: tempRoomAfter ? parseFloat(tempRoomAfter) : null,
